...
```bash
python3 tooling/hub_sweep.py --repo philipdallen/ephapse --dry-run   # print, write nothing
python3 tooling/hub_sweep.py --repo philipdallen/ephapse             # append one snapshot
```
